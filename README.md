...
✓ 设置旋转: L=  0.0° (1500μs) | R=  0.0° (1500μs)

输入角度 (左,右) [例如: 0,0 或 30,-30]: 30,-30
✓ 设置旋转: L= 30.0° (1667μs) | R=-30.0° (1333μs)
...
**更多信息:** 见 `MANUAL_ROTATION_TEST_GUIDE.md`
...
| 文件 | 说明 |
|------|------|
| **test_rotation.py** | 硬件验证脚本，自动运行旋转测试序列 |
| **manual_rotation_test.py** | ⭐ **交互式旋转测试**，手动输入角度测试 |
